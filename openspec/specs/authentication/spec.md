...
Defines user authentication for Decision Mirror: account registration, email/password login, Google OAuth sign-in, logout, protected access, and per-user data isolation.
